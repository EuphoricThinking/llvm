...
private:
  ...
  ur_event_generation_t generation;
...
public:
  ...
  ur_result_t
  runBatchIfCurrentBatch(ur_event_generation_t batch_generation) override;
  ...
  ur_result_t enqueueUSMFill(void *pMem, size_t patternSize,
    ...
    //     phEventWaitList, createEventIfRequested(eventPoolImmediate.get(),
    //     phEvent, this, -1));
    return UR_RESULT_ERROR_INVALID_VALUE;
  }
