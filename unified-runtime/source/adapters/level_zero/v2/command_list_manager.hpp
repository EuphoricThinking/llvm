...
struct ur_command_list_manager {
  ...
  ur_result_t appendMemBufferWrite(ur_mem_handle_t hBuffer, bool blockingWrite,
                                   ...
                                   wait_list_view &waitListView,ur_event_handle_t phEvent);
  ur_result_t
  appendMemBufferReadRect(ur_mem_handle_t hBuffer, bool blockingRead,
  ...
  appendMemBufferMap(ur_mem_handle_t hBuffer, bool blockingMap,
                     ...
                     wait_list_view &waitListView, ur_event_handle_t phEvent, void **ppRetMap);
  ...
  ur_result_t
  appendTimestampRecordingExp(bool blocking,
                              wait_list_view &waitListView, 
                              ur_event_handle_t phEvent);
  ur_result_t
